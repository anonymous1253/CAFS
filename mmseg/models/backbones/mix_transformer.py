...
class MixVisionTransformer(nn.Module):
    def __init__(self, img_size=321, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
